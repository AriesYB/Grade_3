...
public class LogAspect {
     ...
     * @Return void
     */
    @Pointcut("@annotation(com.bosssoft.learning.common.LogApi)")
     ...
     */
    @Around(value = "logPointcut() && @annotation(logApi)", argNames = "point,logApi")
    public Object log(ProceedingJoinPoint point, LogApi logApi) {
        //获取方法名
        String methodName = point.getSignature().getName();
        //获取注解参数
        String operate = logApi.action();
        ...
        sb.append("应答内容:").append(result).append("\n");
        log.info("---log---\n{}", sb.toString());
        return result;
    }
