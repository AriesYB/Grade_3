...
#x1.extend([j*10 for j in range(2,12)])
#x1.extend([k*100 for k in range(2,12)])
...
#创建子图
subplot_p1=fig1.add_subplot(111)#画布1有2个子图
...
#subplot_p1.set_xticks(x1)
#subplot_p2.set_xticks(x1)

p3=subplot_p3.scatter(k,error1,c='red')
p4=subplot_p4.scatter(k,count1,c='blue')
#subplot_p3.set_xticks(x2)
#subplot_p4.set_xticks(x2)
